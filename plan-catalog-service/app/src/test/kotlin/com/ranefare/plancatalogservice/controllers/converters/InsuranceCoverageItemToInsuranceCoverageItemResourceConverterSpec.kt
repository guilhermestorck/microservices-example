...
class InsuranceCoverageItemToInsuranceCoverageItemResourceConverterSpec : Spek({

    val converter by memoized { InsuranceCoverageItemToInsuranceCoverageItemResourceConverter() }
