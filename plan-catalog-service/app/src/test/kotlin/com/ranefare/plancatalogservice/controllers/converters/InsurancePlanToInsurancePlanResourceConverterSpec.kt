...
class InsurancePlanToInsurancePlanResourceConverterSpec : Spek({

    val coverageItemsConverter by memoized { mockk<InsuranceCoverageItemToInsuranceCoverageItemResourceConverter>() }
    val converter by memoized { InsurancePlanToInsurancePlanResourceConverter(coverageItemsConverter) }
